...
/** \mainpage RoboComp::basecontroller
 *
 * \section intro_sec Introduction
 *
 * The basecontroller component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/basecontroller --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class basecontroller : public RoboComp::Application
{
public:
	basecontroller (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::basecontroller::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	tprx = std::make_tuple(fullposeestimation_proxy,laser_proxy,omnirobot_proxy);
...
int main(int argc, char* argv[])
{
	...
	::basecontroller app(prefix, startup_check_flag);
